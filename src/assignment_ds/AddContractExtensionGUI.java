...
import static assignment_ds.ContractExtensionGUI.pqueue;
 ...
 * @author liksh
 */
public class AddContractExtensionGUI extends javax.swing.JFrame {

    String playerName;
    Integer contractDuration;
    Double compositeMark;
     ...
     */
    public AddContractExtensionGUI() {
        initComponents();
    ...
    // Method to transfer player data
    private boolean copyPlayerData(String playerName) {
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password); PreparedStatement selectStmt = conn.prepareStatement(selectQuery)) {
            ...
            if (rs.next()) {
                ...
                contractDuration = rs.getInt("Contract duration");
                compositeMark = rs.getDouble("Composite Mark");
            } else {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(PlayerName, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(303, 303, 303)
    ...
    private void AddInjuredButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddInjuredButtonActionPerformed
        ...
        String addMesj = "Player: " + playerName + "\nStatus: Added to Contract Extension Queue";
        boolean playerExists = checkPlayerInRoster(playerName);

        if (playerExists) {
            // Retrieve player data from the database
            if (copyPlayerData(playerName)) {
                PlayerContract newPlayerContract = new PlayerContract(playerName, contractDuration, compositeMark);

                // Add the player to the queue if not already present
                if (!ContractExtensionGUI.pqueue.contains(newPlayerContract)) {
                    ContractExtensionGUI.pqueue.add(newPlayerContract);
                    ...
                    JOptionPane.showMessageDialog(this, addMesj, "Adding Player to Contract Extension Queue", JOptionPane.INFORMATION_MESSAGE);
                    PlayerName.setText("");

                    // Print updated queue information
                    System.out.println("Updated: \n" + ContractExtensionGUI.pqueue.toString());
                } else {
                    JOptionPane.showMessageDialog(this, "Player is already in the contract extension queue.", "Duplicate Entry", JOptionPane.WARNING_MESSAGE);
                }
            } else {
                // Error copying player data
                PlayerName.setText("");
                JOptionPane.showMessageDialog(this, "Error copying player data to contract extension queue.", "Database Error", JOptionPane.ERROR_MESSAGE);
            }
        } else {
    ...
    private void BackButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackButtonActionPerformed
        this.dispose();
        ContractExtensionGUI gui = new ContractExtensionGUI();
        gui.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddContractExtensionGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
